<?php
/**
 * Customized WP_Statistics_Widget
 */
class Ger_Sch_Statistics extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if (!isset($widget_options['name_widget']) || empty($widget_options['name_widget']))
			$widget_options['name_widget'] = __( 'Statistics', 'wp-statistics' );

		if (!isset($widget_options['icon_widget']) || empty($widget_options['icon_widget']))
	...
	public function form( $instance ) {
		...
		<p>
			<label for="icon_widget"><?php _e( 'Icon', 'wp-statistics' ); ?>:
